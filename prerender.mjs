...
const STATIC_PAGES = [
  { slug: 'business-automation', title: 'Document Automation for Zoho: Certificates & Invoices | PikFinder', description: 'Design a certificate, invoice, letter or ID card once, then auto-generate a personalised copy for every customer from Zoho CRM & Creator or a spreadsheet in one click.', h1: 'Turn your data into finished documents', intro: 'Design once, then generate a personalized document for every record, auto-filled from Zoho CRM, Creator or a spreadsheet. Export as PDF or PNG.' },
  { slug: 'pdf-editor', title: 'Free Online PDF Editor: Edit, Annotate & Export | PikFinder', description: 'Edit PDFs free in your browser: add text and images, annotate, fill forms, rotate pages, and export a clean PDF or PNG. No signup, files stay on your device.', h1: 'Free online PDF editor', intro: 'Add text, images and annotations to any PDF, fill forms, and export right in your browser with zero watermarks.' },
  { slug: 'business', title: 'Document Generator: Create Documents from Your Data | PikFinder', description: 'Pick a template, add your details, and export a finished certificate, invoice or card in seconds, or connect Zoho to auto-fill from your records.', h1: 'Document Generator', intro: 'Pick a template, add your details, and export a finished document in seconds, or connect Zoho to auto-fill from your records.' },
  ...
  { slug: 'backgrounds', title: 'Free Background Generator: Gradients, Patterns & Mesh | PikFinder', description: 'Create beautiful backgrounds free: gradients, mesh, patterns and solid colors. Export in HD for websites, slides and social posts.', h1: 'Free background generator', intro: 'Generate gradient, mesh and pattern backgrounds and export them in HD with no signup needed.' },
  { slug: 'gradient', title: 'Free Gradient Generator: CSS & Image Export | PikFinder', description: 'Build smooth CSS gradients and export them as CSS code or high-resolution images for free.', h1: 'Free gradient generator', intro: 'Design smooth gradients and copy the CSS or export a high-resolution image for free.' },
  { slug: 'about', title: 'About PikFinder: Free Media & In-Browser Design Toolkit', description: 'PikFinder is a creator platform for discovering, editing and organizing free media, built for web designers, marketers and content creators.', h1: 'About PikFinder', intro: 'A creator platform for discovering, editing and organizing free media, built for web designers, marketers and content creators.' },
  { slug: 'products', title: 'Products: Studio, Document Generator, PDF Editor & Tools | PikFinder', description: 'Everything PikFinder offers: free multi-source media search, Creator Studio, Document Generator, PDF editor and dozens of free image tools in one place.', h1: 'Everything in one creator platform', intro: 'Free media search, Creator Studio, Document Generator, PDF editor and dozens of free tools in one place.' },
  { slug: 'blog', title: 'Blog: Guides & Tutorials for Creators | PikFinder', description: 'Practical guides on free stock media, image formats, licensing, color theory, and graphic design from the PikFinder team.', h1: 'Guides for creators', intro: 'Clear, practical writing on free media, formats, licensing, and design.' },
  { slug: 'help', title: 'Help Center | PikFinder', description: 'Guides and answers for using PikFinder: search, Studio, Document Generator, PDF editor and free tools.', h1: 'Help Center', intro: 'Guides and answers for getting the most out of PikFinder.' },
  { slug: 'contact', title: 'Contact PikFinder', description: 'Get in touch with the PikFinder team for support, feedback, partnerships and inquiries.', h1: 'Contact us', intro: 'Questions, feedback or partnership ideas? We would love to hear from you.' },
