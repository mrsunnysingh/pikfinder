...
Editorial, high-resolution photography with a strong point of view. Unsplash is where you go for hero images, mood, and photos that don't look like stock. The license is permissive for commercial use; attribution is appreciated but not required. The trade-off is that its distinctive style can start to feel familiar if you only ever pull from here.

## Pexels

Broad and reliable, with both photos and video. Pexels is a great default when you need something clean and versatile that won't feel like a cliché. Its video library is a genuine bonus for anyone making social content or simple backgrounds.
...
Openverse aggregates openly licensed media from across the web and is worth knowing when you specifically want to filter by Creative Commons license type. Access can be inconsistent for automated tools, but the site itself is a solid place to browse clearly-licensed work.

## How to pick the right source

- Need a striking hero photo? Start with **Unsplash**.
- Making social posts or need video? **Pexels**.
- Hunting something specific or niche? **Pixabay**.
- Need reference, historical, or scientific imagery? **Wikimedia**.
...
- Attribution generated for you when it's required
